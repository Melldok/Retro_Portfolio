  ...
  export const  WorkMobile = () => {
    ...
    <div className='work'>
      ...
      <h2 style={{  margin: 'auto 0', paddingBottom: '20px', fontWeight: 'normal'}}>
        ...
        <Box sx={{ borderBottom: 1, padding: '20px', backgroundColor: 'black' }}>
          <Tabs value={value} onChange={handleChange} 
          aria-label="" variant='scrollable' 
          scrollButtons 
      ...
      <span className="tablePanelDiv d-flex flex-column align-items-center">
